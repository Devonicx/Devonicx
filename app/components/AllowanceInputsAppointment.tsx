...
const AllowanceInputsAppointment: React.FC<AllowanceInputProps> = ({ index }) => {
  interface AllowanceType {
    name: string;
    amount: string;
  }

  let data: any = useSelector((state: RootState) => state.AppointmentLetter);
...
export default AllowanceInputsAppointment;
