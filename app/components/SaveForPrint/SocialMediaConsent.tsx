            ...
            <div className="w-[100%] h-fit flex flex-col justify-between items-start py-1">
              <div className="w-full flex justify-center items-start">
                <div className="text-[14px] font-[400] w-full leading-[23px]">
                  Devonicx uses its Staff/Employee/Internee images on our social
                  media profiles (Facebook, LinkedIn, Twitter, Instagram, etc.)
                  for promoting culture and working environment. This form is
                  for the consent purpose of the individual employees that you
                  are agreeing to use your images/videos on social platforms or
                  not.
                  <div className="py-3 flex flex-col items-start justify-start gap-3">
                    ...
                    <div className="flex justify-between items-center w-full h-[30px]">
                      <div className="flex justify-between items-center gap-[3%] w-[48%] h-full ">
                        ...
                        <div className="w-[70%] h-[100%] border border-black flex justify-start items-center px-3">
                          {formatUperFirst(data.name)}
                        </div>
                      </div>
                      <div className="flex justify-between items-center gap-[3%] w-[48%] h-full ">
                        <span className="w-fit ">CNIC No:</span>
                        <div className="w-[70%] h-[100%] border border-black flex justify-start items-center px-3">
                          {data.cnic}
                        </div>
                      </div>
                    ...
                    <div className="flex justify-between items-center w-full h-[30px]">
                      <div className="flex justify-between items-center gap-[3%] w-[48%] h-full ">
                        <span className="w-fit ">Designation:</span>
                        <div className="w-[70%] h-[100%] border border-black flex justify-start items-center px-3">
                          {data.designation}
                        </div>
                      </div>
                      <div className="flex justify-between items-center gap-[3%] w-[48%] h-full ">
                        <span className="w-fit ">Employee Id:</span>
                        <div className="w-[70%] h-[100%] border border-black flex justify-start items-center px-3">
                          {data.employeeId}
                        </div>
                      </div>
                  ...
                  <div className="py-3 flex flex-col items-start justify-start gap-3">
                    ...
                    <div className="flex flex-col justify-between items-center w-full h-fit gap-1">
                      <div className="flex justify-start items-start gap-[3%] w-full h-full ">
                        <div className="w-[20px] h-[20px] border border-black relative top-[5px]"></div>
                        <span className="w-fit ">
                          ...
                          work environment. In any case, if I leave Devonicx, I
                          shall have no right to make such demand to remove my
                          images and videos from social media profiles which was
                          published for the purpose that is mentioned above.{" "}
                        </span>
                      </div>
                      <div className="flex justify-start items-start gap-[3%] w-full h-full ">
                        <div className="w-[20px] h-[20px] border border-black relative top-[5px]"></div>
                        <span className="w-fit ">
                          I do not authorize Devonicx to use my image or video
                          in which I appeared on any social profiles for any
                          purpose. In case of group image or group video,
                          Devonicx must add emoji/blur my face and can use that
                          image or video on their social media profiles.{" "}
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="py- flex flex-col items-start justify-start gap-1">
                ...
                <div className="flex justify-between items-center w-full h-fit relative top-[5px]">
                  ...
                  <div className="flex justify-end items-end gap-[2%] w-[50%] h-full">
                    <div className="w-[20px] h-[20px] border border-black"></div>
                    other
                    <div className="w-[250px] h-[20px] border-b border-black"></div>
                  </div>
                </div>
              </div>
