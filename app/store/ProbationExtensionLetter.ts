...
export const ProbationExtensionLetterSlice: any = createSlice({
  ...
  reducers: {
    ...
    setProbationExtensionData: (state, action) => {
...
export const {
  ...
  setComLineR,
  setCommissionR,
} = ProbationExtensionLetterSlice.actions;

export default ProbationExtensionLetterSlice.reducer;
