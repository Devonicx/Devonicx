...
export const InternshipExtensionLetterSlice = createSlice({
  name: "InternshipExtensionLetter",
  initialState,
  reducers: {
    ...
    setReasonR: (state, action) => {
      state.reason = action.payload;
    },
    setInternshipExtensionData: (state, action) => {
...
export const {
  ...
  setPrintShowR,
  setReasonR,
} = InternshipExtensionLetterSlice.actions;

export default InternshipExtensionLetterSlice.reducer;
