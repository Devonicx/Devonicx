...
import InternshipExtensionLetterPrint from "@/app/components/SaveForPrint/InternshipExtensionLetter";
...
import {
  ...
  setStipendTextR,
  setReasonR,
} from "@/app/store/InternshipExtensionLetter";
...
const InternshipExtensionLetter: React.FC = () => {
  ...
  let [reason, setReason] = useState(data.reason);
  ...
  useEffect(() => {
    async function verifyTokenApi() {
      try {
        ...
        if (!data.forms.includes("Internship-Extension-Letter")) {
          router.push("/");
        } else {
          setIsVerified(true);
        }
      ...
      async function saveRecord() {
        try {
          ...
          await axios.post("/api/saveRecord", {
            type: "Internship-Extension-Letter",
            dataToSend,
    ...
    <>
      {loading || isVerified === undefined || isVerified === false ? (
        ...
        <div className="w-full h-fit flex flex-col justify-between items-start gap-[40px] py-[50px] hideOnPrint relative">
          ...
          >
            ...
            <div className="w-full h-fit flex justify-between flex-wrap items-start py-8 px-3 md:px-10 xl:px-20 bg-blue-40">
              ...
              <div className="w-[100%] h-fit md:h-[70px] flex justify-between items-start md:items-center">
                <label className="w-[15%] text-[12px] md:text-[14px] xl:text-[18px]  font-[500] flex items-start justify-start gap-[5px]">
                  <FaAsterisk
                    className={` text-[8px] mt-[4px] w-fit ${redColor(
                      data.reason,
                      fieldEmpty,
                ...
                <div className="w-[60%] md:w-[82%] h-fit flex flex-col md:flex-row gap-y-2 md:gap-y-0 justify-start gap-5 items-center text-[12px] md:text-[14px] xl:text-[18px]  ">
                  <button
                    className={`w-full md:w-[23%] h-[45px] rounded-[10px] border-2 border-color flex justify-center items-center hover:border-black ${
                      data.reason === "Lack of knowledge" ? "bg-blue-100" : null
                    }`}
                    onClick={() => {
                      setReason("Lack of knowledge");
                    }}
                  >
                    Lack of knowledge
                  </button>
                  <button
                    className={`w-full md:w-[23%] h-[45px] rounded-[10px] border-2 border-color flex justify-center items-center hover:border-black ${
                      data.reason === "Excessive Leaves" ? "bg-blue-100" : null
                    }`}
                    onClick={() => {
                      setReason("Excessive Leaves");
                    }}
                  >
                    Excessive Leaves
                  </button>
          ...
          <RecentRecord
            letterType={"Internship-Extension-Letter"}
        ...
        <div className="w-full h-fit flex justify-center items-center overflow-auto">
          ...
          <div className="w-full h-full overflow-auto">
            <InternshipExtensionLetterPrint />
          </div>
        </div>
      )}
    </>
...
export default InternshipExtensionLetter;
